...
(
    ...
    impl_plan_profile  varchar(10) not null comment '分红方案',
    equity_record_date datetime    not null comment '股权登记日',
    ex_dividend_date   datetime    not null comment '除权除息日',
...
(
    ...
    ipo_num           double default null comment '新股发行(万股)',
    issue_way_explain varchar(20) not null comment '发行方式',
    reg_date          datetime    not null comment '股权登记日',
