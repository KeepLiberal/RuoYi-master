...
CREATE TABLE `inv_finance_zyzb_year` (
  ...
  `zcfzltz` double DEFAULT NULL COMMENT '1',
  `nbv_rate` double DEFAULT NULL COMMENT '1',
  `roejqtz` double DEFAULT NULL COMMENT '1',
  `djd_deductdpnp_yoy` double DEFAULT NULL COMMENT '1',
  `bpstz` double DEFAULT NULL COMMENT '1',
  `roic` double DEFAULT NULL COMMENT '1',
  `roictz` double DEFAULT NULL COMMENT '1',
  `report_year` double DEFAULT NULL COMMENT '1',
  `mgjyxjjetz` double DEFAULT NULL COMMENT '1',
  `djd_dpnp_yoy` double DEFAULT NULL COMMENT '1',
  `mgzbgjtz` double DEFAULT NULL COMMENT '1',
  `zzcjlltz` double DEFAULT NULL COMMENT '1',
  `djd_dpnp_qoq` double DEFAULT NULL COMMENT '1',
  `mgwfplrtz` double DEFAULT NULL COMMENT '1',
  `djd_deductdpnp_qoq` double DEFAULT NULL COMMENT '1',
  `nbv_life` double DEFAULT NULL COMMENT '1',
  `nhjz_current_amt` double DEFAULT NULL COMMENT '1',
  `djd_toi_qoq` double DEFAULT NULL COMMENT '1',
  `djd_toi_yoy` double DEFAULT NULL COMMENT '1',
