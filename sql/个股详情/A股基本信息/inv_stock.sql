...
create table `inv_stock` (
  ...
  `name`  varchar(10) character set utf8mb4 collate utf8mb4_general_ci not null comment '股票简称',
  `market` varchar(10) character set utf8mb4 collate utf8mb4_general_ci default null comment '股票市场',
  `org_code` varchar(10) character set utf8mb4 collate utf8mb4_general_ci default null comment '组织代码',
  `org_type` varchar(10) character set utf8mb4 collate utf8mb4_general_ci default null comment '组织简称',
  `security_type_code`  varchar(10) character set utf8mb4 collate utf8mb4_general_ci default null  comment '股票分类代码',
