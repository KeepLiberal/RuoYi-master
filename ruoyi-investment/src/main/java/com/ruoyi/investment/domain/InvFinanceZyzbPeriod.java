...
/**
 * 财务分析-重要指标-报告期对象 inv_finance_zyzb_period
 * 
 * @author ruoyi
 * @date 2022-09-26
 */
public class InvFinanceZyzbPeriod extends BaseEntity
{
    ...
    public InvFinanceZyzbPeriod() {
        super();
    }

    public InvFinanceZyzbPeriod(String securityCode) {
        this.securityCode = securityCode;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InvFinanceZyzbPeriod)) return false;
        InvFinanceZyzbPeriod that = (InvFinanceZyzbPeriod) o;
        return Objects.equals(id, that.id) && Objects.equals(securityCode, that.securityCode) && Objects.equals(reportDate, that.reportDate) && Objects.equals(noticeDate, that.noticeDate) && Objects.equals(updateDate, that.updateDate) && Objects.equals(yszkyysr, that.yszkyysr) && Objects.equals(rzrqywfxzb, that.rzrqywfxzb) && Objects.equals(zygdsylzqjzb, that.zygdsylzqjzb) && Objects.equals(totaldeposits, that.totaldeposits) && Objects.equals(xsjll, that.xsjll) && Objects.equals(mlr, that.mlr) && Objects.equals(kcfjcxsyjlr, that.kcfjcxsyjlr) && Objects.equals(earnedPremium, that.earnedPremium) && Objects.equals(jzbjzc, that.jzbjzc) && Objects.equals(zzczzts, that.zzczzts) && Objects.equals(mgwfplr, that.mgwfplr) && Objects.equals(taxrate, that.taxrate) && Objects.equals(yszkzzl, that.yszkzzl) && Objects.equals(cqbl, that.cqbl) && Objects.equals(zygpgmjzc, that.zygpgmjzc) && Objects.equals(kfjlrgdhbzc, that.kfjlrgdhbzc) && Objects.equals(ltdrr, that.ltdrr) && Objects.equals(solvencyAr, that.solvencyAr) && Objects.equals(epsjb, that.epsjb) && Objects.equals(jjywfxzb, that.jjywfxzb) && Objects.equals(zqzyywfxzb, that.zqzyywfxzb) && Objects.equals(roekcjq, that.roekcjq) && Objects.equals(surrenderRateLife, that.surrenderRateLife) && Objects.equals(yyzsrgdhbzc, that.yyzsrgdhbzc) && Objects.equals(zcfzl, that.zcfzl) && Objects.equals(jyxjlyysr, that.jyxjlyysr) && Objects.equals(qycs, that.qycs) && Objects.equals(zzcjll, that.zzcjll) && Objects.equals(bps, that.bps) && Objects.equals(nzbje, that.nzbje) && Objects.equals(roejq, that.roejq) && Objects.equals(yszkzzts, that.yszkzzts) && Objects.equals(djdDeductdpnpYoy, that.djdDeductdpnpYoy) && Objects.equals(xsmll, that.xsmll) && Objects.equals(kcfjcxsyjlrtz, that.kcfjcxsyjlrtz) && Objects.equals(totaloperatereve, that.totaloperatereve) && Objects.equals(sd, that.sd) && Objects.equals(chzzts, that.chzzts) && Objects.equals(mgzbgj, that.mgzbgj) && Objects.equals(parentnetprofit, that.parentnetprofit) && Objects.equals(nonperloan, that.nonperloan) && Objects.equals(totalRoi, that.totalRoi) && Objects.equals(zqcxywfxzb, that.zqcxywfxzb) && Objects.equals(chzzl, that.chzzl) && Objects.equals(netRoi, that.netRoi) && Objects.equals(grossloans, that.grossloans) && Objects.equals(epskcjb, that.epskcjb) && Objects.equals(netprofitrphbzc, that.netprofitrphbzc) && Objects.equals(hxyjbczl, that.hxyjbczl) && Objects.equals(parentnetprofittz, that.parentnetprofittz) && Objects.equals(toazzl, that.toazzl) && Objects.equals(totaloperaterevetz, that.totaloperaterevetz) && Objects.equals(epsxs, that.epsxs) && Objects.equals(compensateExpense, that.compensateExpense) && Objects.equals(jzc, that.jzc) && Objects.equals(jzb, that.jzb) && Objects.equals(djdToiYoy, that.djdToiYoy) && Objects.equals(bldkbbl, that.bldkbbl) && Objects.equals(ld, that.ld) && Objects.equals(newcapitalader, that.newcapitalader) && Objects.equals(xsjxlyysr, that.xsjxlyysr) && Objects.equals(mgjyxjje, that.mgjyxjje) && Objects.equals(yyfxzb, that.yyfxzb) && Objects.equals(xjllb, that.xjllb) && Objects.equals(epsjbtz, that.epsjbtz) && Objects.equals(djdDeductdpnpQoq, that.djdDeductdpnpQoq) && Objects.equals(mgwfplrtz, that.mgwfplrtz) && Objects.equals(djdToiQoq, that.djdToiQoq) && Objects.equals(nbvLife, that.nbvLife) && Objects.equals(nhjzCurrentAmt, that.nhjzCurrentAmt) && Objects.equals(mgjyxjjetz, that.mgjyxjjetz) && Objects.equals(djdDpnpYoy, that.djdDpnpYoy) && Objects.equals(mgzbgjtz, that.mgzbgjtz) && Objects.equals(zzcjlltz, that.zzcjlltz) && Objects.equals(djdDpnpQoq, that.djdDpnpQoq) && Objects.equals(roic, that.roic) && Objects.equals(roictz, that.roictz) && Objects.equals(zcfzltz, that.zcfzltz) && Objects.equals(nbvRate, that.nbvRate) && Objects.equals(roejqtz, that.roejqtz) && Objects.equals(bpstz, that.bpstz);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, securityCode, reportDate, noticeDate, updateDate, yszkyysr, rzrqywfxzb, zygdsylzqjzb, totaldeposits, xsjll, mlr, kcfjcxsyjlr, earnedPremium, jzbjzc, zzczzts, mgwfplr, taxrate, yszkzzl, cqbl, zygpgmjzc, kfjlrgdhbzc, ltdrr, solvencyAr, epsjb, jjywfxzb, zqzyywfxzb, roekcjq, surrenderRateLife, yyzsrgdhbzc, zcfzl, jyxjlyysr, qycs, zzcjll, bps, nzbje, roejq, yszkzzts, djdDeductdpnpYoy, xsmll, kcfjcxsyjlrtz, totaloperatereve, sd, chzzts, mgzbgj, parentnetprofit, nonperloan, totalRoi, zqcxywfxzb, chzzl, netRoi, grossloans, epskcjb, netprofitrphbzc, hxyjbczl, parentnetprofittz, toazzl, totaloperaterevetz, epsxs, compensateExpense, jzc, jzb, djdToiYoy, bldkbbl, ld, newcapitalader, xsjxlyysr, mgjyxjje, yyfxzb, xjllb, epsjbtz, djdDeductdpnpQoq, mgwfplrtz, djdToiQoq, nbvLife, nhjzCurrentAmt, mgjyxjjetz, djdDpnpYoy, mgzbgjtz, zzcjlltz, djdDpnpQoq, roic, roictz, zcfzltz, nbvRate, roejqtz, bpstz);
    }
